...
public class MathTest {
	...
	public final void testMatrix() {
		...
		assertEquals(true, m.identity().equals(m2.identity()));
		m = new Matrix(2,3);
		assertEquals(null, m.identity());
		assertEquals(null, m.inverse());///@todo 
		assertEquals(true, m.equals(m));
		assertEquals(false, m.equals(m2.zero()));
		assertEquals(null, m.multiply(m2));
		m = new Matrix(2,2);
		assertEquals(false, m.identity().equals(m2));
		assertEquals(false, m.identity().equals(v));
