...
public class CompositeCode implements ICode {
	...
	public ISymbol getSymbol() {
		/*
		 * if(sc==null) sc=new CompositeSymbol(c1.getSymbol(), c2.getSymbol());
		 */
		return sc;
	}
	...
	public static int getC2Length(ISymbol s1) {
		...
		case 0x10F:
			return 0;// "EOS";
		case 0x110:
			return 0;// "EOBS";// End of Bit Stream
		case 0x111:
			return 0;// "PAT";
		case 0x112:
			return 0;// "PATr";
		...
		case 0x115:
			return 0;// "IntAsASCII";
		case 0x117:
			return 0;// "FloatAsASCII";
		case 0x118:
			return 0;// "FloatAsASCIIes2";
		case 0x119:
			return 0;// "DoubleAsASCIIes3";
		case 0x11A:
			return 0;// "CRLF";
		case 0x11B:
			return 0;// "SOS";
