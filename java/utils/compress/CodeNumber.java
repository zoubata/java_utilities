...
public class CodeNumber  {
	...
	static final int UnaryCoding=0;
	...
	public static	Long readGammaCode(IBinaryReader bin)
	{
		...
		return B;
		/*
		Long u=readUnaryCode(bin);
		int B=bin.readInt(u.intValue());
		long n=B+1<<u;
		return n;*/
	}
	...
	static final int Rice5Coding=33;
	static final int Rice6Coding=34;
	static final int Rice7Coding=35;
	static final int Rice8Coding=36;
	...
	static final int GolombkCoding=11;
	...
	static final int ZetaCoding=13;
	static final int Zeta1Coding=37;
	static final int Zeta2Coding=38;
	static final int Zeta3Coding=39;
	static final int Zeta4Coding=40;
	//https://fr.wikipedia.org/wiki/Codage_zeta
	static final int MaxCodingIndex=40;	
	/**
	 * n :  size of alphabet
	 * x: symbol inside the alphabet
	 * */
	...
	while(n>0)
		{
		c=new Code( new Code(new Code(f,1),new Code(n&0x7F,7)),c);n=n>>7;f=1;
		}
				return c;
			}
	...
	if(n>=15)
	{c=new Code(c,new Code(15,4));n-=15;}
	else
		return new Code(n,4);
		while (n>=255)
			{c=new Code(c,new Code(Math.min(n,255),8));n-=255;}
	...
	{
	long n=0;
	long b=bin.readLong(4);
			n+=b;
	if (b>=15)
	{while((b=bin.readLong(8))>=255)
		n+=b;
	...
	static final int NibblesCoding=16;
	//https://github.com/lz4/lz4/blob/master/doc/lz4_Block_format.md
	// Byte coding : https://en.wikipedia.org/wiki/Universal_code_(data_compression)
	//nibbles codding :	
		/*
		0..3 ; C..F=7 ; 3C..3F=11 : FC..FF=15
		0..F ; F0..FF=31 ; FF0..FFF=47 
		00..FF ; FF00..FFFF=511
	...
	public static	ICode getNibblesCode(long n)
	{
		...
		{c=new Code(c,new Code(15,4));n-=15;}
			...
			return new Code(n,4);
			while (n>=15)
				{c=new Code(c,new Code(Math.min(n,15),4));n-=15;}
	...
	// custom SL3+X
	/*
	0bSLLLxxxx xxxx xxxx
    S 0 x>=0 1 x<0
    LLL : 0 only xxxx           0..15
          1      xxxx xxxx          16...16+255
          2      xxxx xxxx xxxx     16+256+0..4096
          ...
          7      xxxx X8 => 2**64
          */
	// custom L2+X...
	...
	LL : 0  xx  0..3
	     1  xxxxxx  4..63+4
	     2  XX XXXX XXXXXXXX : 4+64+0..16383
...
*/
	...
	ICode c;
		for(i=0;i<1000;i++)
			...
			for(int j=0;j<=40;j++)
				...
				System.out.print(", "+((((c=getCode(j,i))!=null) && (c.toRaw()!=null))?c.toRaw().length():""));
			System.out.println();
	}
		}
	...
	public static Long readCode(int keycode, IBinaryReader num) {
		switch (keycode) {
		case CodeNumber.ExpGolombCoding: return readExpGolomb0Code(num);
		case CodeNumber.DeltaCoding: return readDeltaCode(num);
		case CodeNumber.EvenRodehCoding: return readEvenRodehCode(num);
		case CodeNumber.ExpGolomb1OrderCoding: return readExpGolombkCode(1,num);
		case CodeNumber.ExpGolomb2OrderCoding: return readExpGolombkCode(2,num);
		case CodeNumber.ExpGolomb3OrderCoding: return readExpGolombkCode(3,num);
		case CodeNumber.ExpGolomb4OrderCoding: return readExpGolombkCode(4,num);
		case CodeNumber.FibonacciCoding: return readFibonacciCode(num);
		case CodeNumber.GammaCoding: return readGammaCode(num);
		case CodeNumber.Golomb1Coding: return readGolombkCode(1,num);
		case CodeNumber.Golomb2Coding: return readGolombkCode(2,num);
		case CodeNumber.Golomb8Coding: return readGolombkCode(8,num);
		case CodeNumber.Golomb16Coding: return readGolombkCode(16,num);
		case CodeNumber.LevenshteinCoding: return readLevenshteinCode(num);
		case CodeNumber.LZ4Coding: return readLZ4Code(num);
		case CodeNumber.NibblesCoding: return readNibblesCode(num);
		case CodeNumber.OmegaCoding: return readOmegaCode(num);
		case CodeNumber.PhaseInCoding: return readPhaseInCode(Symbol.getNbSymbol(),num);
		case CodeNumber.Rice0Coding: return readRiceCode(0,num);
		case CodeNumber.Rice1Coding: return readRiceCode(1,num);
		case CodeNumber.Rice2Coding: return readRiceCode(2,num);
		case CodeNumber.Rice3Coding: return readRiceCode(3,num);
		case CodeNumber.Rice4Coding: return readRiceCode(4,num);
		case CodeNumber.Rice5Coding: return readRiceCode(5,num);
		case CodeNumber.Rice6Coding: return readRiceCode(6,num);
		case CodeNumber.Rice7Coding: return readRiceCode(7,num);
		case CodeNumber.Rice8Coding: return readRiceCode(8,num);
		case CodeNumber.UnaryCoding: return readUnaryCode(num);
		case CodeNumber.VLQCoding: return readVLQCode(num);
		case CodeNumber.Zeta1Coding: return readZetaCode(1,num);
		case CodeNumber.Zeta2Coding: return readZetaCode(2,num);
		case CodeNumber.Zeta3Coding: return readZetaCode(3,num);
		case CodeNumber.Zeta4Coding: return readZetaCode(4,num);
	...
	public static ICode getCode(int keycode, long num) {
		switch (keycode) {
		case CodeNumber.ExpGolombCoding: return getExpGolomb0Code(num);
		case CodeNumber.DeltaCoding: return getDeltaCode(num);
		case CodeNumber.EvenRodehCoding: return getEvenRodehCode(num);
		case CodeNumber.ExpGolomb1OrderCoding: return getExpGolombkCode(1,num);
		case CodeNumber.ExpGolomb2OrderCoding: return getExpGolombkCode(2,num);
		case CodeNumber.ExpGolomb3OrderCoding: return getExpGolombkCode(3,num);
		case CodeNumber.ExpGolomb4OrderCoding: return getExpGolombkCode(4,num);
		case CodeNumber.FibonacciCoding: return getFibonacciCode(num);
		case CodeNumber.GammaCoding: return getGammaCode(num);
		case CodeNumber.Golomb1Coding: return getGolombkCode(1,num);
		case CodeNumber.Golomb2Coding: return getGolombkCode(2,num);
		case CodeNumber.Golomb8Coding: return getGolombkCode(8,num);
		case CodeNumber.Golomb16Coding: return getGolombkCode(16,num);
		case CodeNumber.LevenshteinCoding: return getLevenshteinCode(num);
		case CodeNumber.LZ4Coding: return getLZ4Code(num);
		case CodeNumber.NibblesCoding: return getNibblesCode(num);
		case CodeNumber.OmegaCoding: return getOmegaCode(num);
		case CodeNumber.PhaseInCoding: return getPhaseInCode(Symbol.getNbSymbol(),num);
		case CodeNumber.Rice0Coding: return getRiceCode(0,num);
		case CodeNumber.Rice1Coding: return getRiceCode(1,num);
		case CodeNumber.Rice2Coding: return getRiceCode(2,num);
		case CodeNumber.Rice3Coding: return getRiceCode(3,num);
		case CodeNumber.Rice4Coding: return getRiceCode(4,num);
		case CodeNumber.Rice5Coding: return getRiceCode(5,num);
		case CodeNumber.Rice6Coding: return getRiceCode(6,num);
		case CodeNumber.Rice7Coding: return getRiceCode(7,num);
		case CodeNumber.Rice8Coding: return getRiceCode(8,num);
		case CodeNumber.UnaryCoding: return getUnaryCode(num);
		case CodeNumber.VLQCoding: return getVLQCode(num);
		case CodeNumber.Zeta1Coding: return getZetaCode(1,num);
		case CodeNumber.Zeta2Coding: return getZetaCode(2,num);
		case CodeNumber.Zeta3Coding: return getZetaCode(3,num);
		case CodeNumber.Zeta4Coding: return getZetaCode(4,num);
