...
public class ArithmeticCompress  {
	...
	public static void main(String[] args) throws IOException {
		...
		IFrequencyTable freqs = getFrequencies(inputFile);
	...
	private static IFrequencyTable getFrequencies(File file) throws IOException {
		IFrequencyTable freqs = new SimpleFrequencyTable(new int[257]);
	...
	public static void writeFrequencies(BitOutputStream out, IFrequencyTable freqs) throws IOException {
		for (int i = 0; i < 256; i++)
	...
	// To allow unit testing, this method is package-private instead of private.
	public static void compress(IFrequencyTable freqs, InputStream in, BitOutputStream out) throws IOException {
