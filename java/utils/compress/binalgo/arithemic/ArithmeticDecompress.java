...
public class ArithmeticDecompress {
	...
	public static void main(String[] args) throws IOException {
		...
		try (BitInputStream in = new BitInputStream(new BufferedInputStream(new FileInputStream(inputFile)));
			...
			IFrequencyTable freqs = readFrequencies(in);
	...
	public static IFrequencyTable readFrequencies(BitInputStream in) throws IOException {
	...
	// To allow unit testing, this method is package-private instead of private.
	public static void decompress(IFrequencyTable freqs, BitInputStream in, OutputStream out) throws IOException {
