 ...
 * 
 *         this class can be used to do a processing on a Binary data: a
 *         compression, an encryption, and redondancy adder, or a checker adder.
 *
 */
public class BinaryPipeAlgo extends BinaryFinFout {
	...
	/**
	 * for caesar cipher, piplines a IBinaryReader This will override the behaviour
	 * of reader to de/encrypt the data. my key is an integer between 0 and
	 * 1^keysize-1 keysize : 1,2,4,8,16,32 encrypt=true, will encrypt the data from
	 * reader encrypt=false, will decrypt the data from reader
	 */
	...
	/**
	 * for caesar cipher, piplines a IBinaryWriter this will override the behaviour
	 * of writer to de/encrypt the data. my key is an integer between 0 and
	 * 1^keysize-1 keysize : 1,2,4,8,16,32 encrypt=true, will encrypt the data to
	 * writer encrypt=false, will decrypt the data to writer
	 */
	...
	public static void main(String[] args) {
		/*
		 * // TODO Auto-generated method stub BinaryFinFout fifo =new BinaryFinFout();
		 ...
		 * bout.flush(); // System.out.println("'"+fifo.readString(12)+"'"); //
		 * fifo.flush(); System.out.println("'"+fifo.readString(13)+"'");
