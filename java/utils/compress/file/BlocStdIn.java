 ...
 * 
 * a bloc is a n by n word memory area, and the word size is l byte.
 * the block size is n*n*l bytes.
 * uncompleted block is filled with 0
 *
 */
public class BlocStdIn {

	BufferedInputStream in;
	int n=1; public  byte[] readBlock( ) {
	 ...
	 byte l;
	/**	
	 * n²:size of the block in word
	 * l: the word size in byte, usually 8
	 */
