...
public List<ISymbol> processUncompress(ISymbol n0)
{
	...
	/*	SymbolINT64 i1=(SymbolINT64)n1;
		Long pos=i1.getS2().getLong();
		SymbolINT64 i0=(SymbolINT64)n0;
		Long len=i0.getS2().getLong();
		*/
...
public List<ISymbol> processcompress(ISymbol s)
{
	...
	{	
		...
		/*	if (pos<Byte.MAX_VALUE)
				ls.add(new SymbolINT8(pos.byteValue()));
			else if (pos<Short.MAX_VALUE)
					ls.add(new SymbolINT16(pos.shortValue()));
			else if (pos<Integer.MAX_VALUE)
					ls.add(new SymbolINT32(pos.intValue()));
			else
			
			*/	ls.add(Symbol.FactorySymbolINT(pos.longValue()));
						
			/*if (len<Byte.MAX_VALUE)
				ls.add(new SymbolINT8(len.byteValue()));
			else if (len<Short.MAX_VALUE)
					ls.add(new SymbolINT16(len.shortValue()));
			else if (len<Integer.MAX_VALUE)
					ls.add(new SymbolINT32(len.intValue()));
			else
				*/
