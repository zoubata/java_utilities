...
public class Sym_LZS extends CompositeSymbols {
	 ...
	 * length : 2..37
	 * 
	 * offset= this.getS1().getId()
	 * length= this.getS2().getId()
	 * the bit stream is this.getCode()
	 * according to https://en.wikipedia.org/wiki/Lempel%E2%80%93Ziv%E2%80%93Stac
	 * */
	public Sym_LZS(int offset, int length) {
		
		
		super(Symbol.LZS,
				new Symbol(offset,(offset>-128)?new Code(-offset+128,8):new Code(-offset,12)), 
				new Symbol(length,lenCode[length])
