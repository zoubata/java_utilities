...
//	System.out.println(new String(Symbol.listSymbolToCharSeq(ls)));
	...
	public void testBpeBasicAll() {
		...
		testBPEBasic( "11",0);
		testBPEBasic( "1",0);
		testBPEBasic("test de compression AAAAAAAAAAAAAAAAA CDCDCDCDCDCDCD test de compression AAAAAAAAAAAAAAAAA CDCDCDCDC\n"
				,101-101);
		...
		testBPEBasic( "klefnhatrytvzyeryyteyrretouizybrebyyelkjkdjfhgjksdnjkdsj,vvi,ouybiotruybiortuyioruyoirtyebetyryetberybre"
		...
		long nano_startTime = System.nanoTime(); 			
		testBPEBasic( LZWBasic.file,8722-9327);			
		long nano_stopTime = System.nanoTime(); 
