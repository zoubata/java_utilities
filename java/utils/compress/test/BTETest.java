...
//	System.out.println(new String(Symbol.listSymbolToCharSeq(ls)));
	...
	public void testBTE_Perf() {
		long timens=120*1000*1000L;//0.22s
	...
	//	testBTEBasic( "1",0);
		...
		testBTEBasic("test de compression AAAAAAAAAAAAAAAAA CDCDCDCDCDCDCD test de compression AAAAAAAAAAAAAAAAA CDCDCDCDC\n"
				,101-86);
		...
		testBTEBasic( "klefnhatrytvzyeryyteyrretouizybrebyyelkjkdjfhgjksdnjkdsj,vvi,ouybiotruybiortuyioruyoirtyebetyryetberybre"
