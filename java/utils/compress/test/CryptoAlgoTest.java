...
import com.zoubworld.java.utils.cryptography.EnigmaAlgo;
...
public class CryptoAlgoTest {
	...
	public final void test() {
		...
		/*
		EnigmaAlgo c5=new EnigmaAlgo("abc");
		assertEquals(e, c5.encrypt('A').intValue());
		assertEquals(e, c5.encrypt('A').intValue());
		assertEquals(e, c5.encrypt('A').intValue());
		c5.reset();
		assertEquals((int)'A', c5.decrypt('B').intValue());
		assertEquals((int)'A', c5.decrypt('B').intValue());
		assertEquals((int)'A', c5.decrypt('B').intValue());
		*/
