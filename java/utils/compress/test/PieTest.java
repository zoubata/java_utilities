...
//	System.out.println(new String(Symbol.listSymbolToCharSeq(ls)));
	...
	public void testPIEBasicAll() {
		...
		testPIEBasic( "12",0);
		testPIEBasic( "1",0);
		testPIEBasic("test de compression AAAAAAAAAAAAAAAAA CDCDCDCDCDCDCD test de compression AAAAAAAAAAAAAAAAA CDCDCDCDC\n"
				,101-89);
		...
		testPIEBasic( "klefnhatrytvzyeryyteyrretouizybrebyyelkjkdjfhgjksdnjkdsj,vvi,ouybiotruybiortuyioruyoirtyebetyryetberybre"
		...
		long nano_startTime = System.nanoTime(); 			
		testPIEBasic( LZWBasic.file,9347-6350);			
		long nano_stopTime = System.nanoTime(); 
