 ...
 *         of one or three characters. in fact it is a 32bits cipher. because
 *         module is implicit, for a real 8 bits you have to change algo with 4
 *         %256 info : http://www.crypto-it.net/eng/simple/index.html
 */
public class CaesarCipher32 implements ICryptoAlgo {
	 ...
	 * my key is an int between 0 and 1^keysize-1 keysize : 1,2,4,8,16,32 .
	 */
