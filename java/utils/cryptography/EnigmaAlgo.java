...
public class EnigmaAlgo implements ICryptoAlgo {
	...
	public Integer encrypt(int data) {		
		return M.convertChar((char)(data&0xff))
				|  M.convertChar((char)((data>>8)&0xff))<<8
				| M.convertChar((char)((data>>16)&0xff))<<16
				| M.convertChar((char)((data>>24)&0xff))<<24;
	}
	...
	public Integer decrypt(int data) {
		return M.convertChar((char)((data>>24)&0xff))<<24
				| M.convertChar((char)((data>>16)&0xff))<<16
				| M.convertChar((char)((data>>8)&0xff))<<8
				| M.convertChar((char)(data&0xff));
	}
	@Override
