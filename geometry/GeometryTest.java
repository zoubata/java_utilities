...
public class GeometryTest {
	...
	public void testVector() {
		...
		assertEquals("<line x1=\"0.0mm\" y1=\"0.0mm\" x2=\"3000.0mm\" y2=\"3000.0mm\" style=\"stroke:rgb(0,0,255);stroke-width:4\" /><line x1=\"17.67766952966369mm\" y1=\"-17.677669529663692mm\" x2=\"-17.67766952966369mm\" y2=\"17.677669529663692mm\" style=\"stroke:rgb(0,0,255);stroke-width:4\" /><circle  cx=\"17.67766952966369mm\" cy=\"-17.677669529663692mm\" r=\"6mm\" style=\"fill:rgb(255,0,0)\" /><circle  cx=\"-17.67766952966369mm\" cy=\"17.677669529663692mm\" r=\"6mm\" style=\"fill:rgb(255,0,0)\" /><line x1=\"3000.0mm\" y1=\"3000.0mm\" x2=\"2903.4074173710933mm\" y2=\"2974.1180954897477mm\" style=\"stroke:rgb(0,0,255);stroke-width:4\" /><circle  cx=\"3000.0mm\" cy=\"3000.0mm\" r=\"6mm\" style=\"fill:rgb(255,0,0)\" /><circle  cx=\"2903.4074173710933mm\" cy=\"2974.1180954897477mm\" r=\"6mm\" style=\"fill:rgb(255,0,0)\" /><line x1=\"3000.0mm\" y1=\"3000.0mm\" x2=\"2974.1180954897477mm\" y2=\"2903.4074173710933mm\" style=\"stroke:rgb(0,0,255);stroke-width:4\" /><circle  cx=\"3000.0mm\" cy=\"3000.0mm\" r=\"6mm\" style=\"fill:rgb(255,0,0)\" /><circle  cx=\"2974.1180954897477mm\" cy=\"2903.4074173710933mm\" r=\"6mm\" style=\"fill:rgb(255,0,0)\" />", v.toSvg());
	}
	...
	public void testSegment() {
		...
		assertTrue(s.contient(p05.getX0(), p05.getY0()));
		...
		assertNotEquals(s.getMilieu(),null);
	...
	//	assertTrue(d45.equals(d));
		...
		assertEquals(d.toSvg(),
				"<line x1=\"-1000000.0mm\" y1=\"-999999.9999999999mm\" x2=\"1000000.0mm\" y2=\"999999.9999999999mm\" style=\"stroke:rgb(255,0,0);stroke-width:2\" />");
		assertEquals(d.toString(), "Droite(y=1.000000*x+0.000000)");
	...
	public void testSegment2() {
		...
		Point p0 = new Point(x, x * a + b);
		x = Math.random() * 5;
		Point p1 = new Point(x, x * a + b);
		x = Math.random() * 50;
		Point p2 = new Point(x, x * a + b);
		x = Math.random() * 20;
		Point p3 = new Point(x, x * a + b);
		x = Math.random() * 155;
		...
		Unit u=new Unit();
		assertEquals(/*1000.0*/null,u.convert(1.0, "m", "mm")/*,0.001*/);
	}
	...
	public void testSegment4() {
		...
		Point p0 = new Point(x, x * a + b + 1);
		x = Math.random() * 5;
		Point p1 = new Point(x, x * a + b + 2);
		x = Math.random() * 50;
		Point p2 = new Point(x, x * a + b + 4);
		x = Math.random() * 20;
		Point p3 = new Point(x, x * a + b + 0);
		x = Math.random() * 155;
	...
	public void testSegment3() {
		...
		Point p0 = new Point(x, x * a + b + r());
		x = 5.0;
		Point p1 = new Point(x, x * a + b + r());
		x = 50.0;
		Point p2 = new Point(x, x * a + b + r());
		x = 20.0;
		Point p3 = new Point(x, x * a + b + r());
		x = 155.0;
