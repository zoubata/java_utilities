...
package com.zoubworld.Crypto.server.Peer.peerbase.sample;
...
public class FileShareNode extends Node {
	...
	public FileShareNode(int maxPeers, IPeerInfo myInfo) {
	...
	public void buildPeers(String host, int port, int hops) {
		...
		List<IPeerMessage> resplist = this.connectAndSend(pd, PEERNAME, "", true);
	...
	private class JoinHandler implements IHandler {
		private Node peer;
	...
	/* msg syntax: LIST */
	private class ListHandler implements IHandler {
		private Node peer;
	...
	/* msg syntax: NAME */
	private class NameHandler implements IHandler {
		private Node peer;
	...
	private class QueryHandler implements IHandler {
	...
	private class QResponseHandler implements IHandler {
	...
	private class FileGetHandler implements IHandler {
		@SuppressWarnings("unused")
		private Node peer;
	...
	/* msg syntax: QUIT pid */
	private class QuitHandler implements IHandler {
		private Node peer;
	...
	private class Router implements IRouter {
		private Node peer;
