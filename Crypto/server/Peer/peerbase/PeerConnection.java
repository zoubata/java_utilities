...
public class PeerConnection {
	 ...
	 */
	public PeerConnection(IPeerInfo info) 
	 ...
	 * @param socket
	 */
	public PeerConnection(IPeerInfo info, SocketInterface socket) {
		pd = info;
		s = socket;
	}
	 ...
	 */
	public void sendData(IPeerMessage msg) {
		try {
			s.write(msg.toBytes());
		}
		catch (IOException e) {
	 ...
	 */
	public IPeerMessage recvData() {
		try {
			IPeerMessage msg = new PeerMessage(s);
			return msg;
		}
		catch (IOException e) {
